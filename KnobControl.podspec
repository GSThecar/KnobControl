...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "GSThecar" => "thecar3774@gmail.com" }
  # Or just: spec.author    = "GSThecar"
  # spec.authors            = { "GSThecar" => "thecar3774@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/GSThecar"
  ...
  spec.source       = { :git => "https://github.com/GSThecar/KnobControl.git", :tag => "1.0.0" }
